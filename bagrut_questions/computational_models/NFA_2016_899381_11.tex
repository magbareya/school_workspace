...
$$L = (L1 \cdot L2) \cup (\overline{L_1} \cdot \overline{L_2})$$

\begin{itemize}
\item $L_1$ و $L_2$ نظاميّتان حسب المعطى $\leftarrow$ $L_1 \cdot L_2$ نظامية لأنّ اللغات النظامية منغلقة تحت عملية الإلصاق.
...
\item $\overline{L_1} \cdot \overline{L_2}$ نظامية لأنّ اللغات النظامية منغلقة تحت عملية الإلصاق.
\item $L = (L1 \cdot L2) \cup (\overline{L_1} \cdot \overline{L_2})$ نظامية لأنّها اتّحاد لغتين نظاميّتين.
\end{itemize}

\clearpage
\item .
\begin{center}
    \includegraphics[width=0.5\paperwidth,keepaspectratio]{../../../images/DFAs/an_bm_one_even_other_odd.png}%
\end{center}
