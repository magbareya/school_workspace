\subsection*{سؤال 13 امتحان 899381 سنة 2022}
\addcontentsline{toc}{subsection}{سؤال 13 امتحان 899381 سنة 2022}

\insertFullImg{../../../bagrut_questions/computational_models/PDA_2022_899381_13.png}

\ifwithsols
\begin{boxSolution}[سؤال 13 امتحان 899381 سنة 2022]
    \textbf{أ.} \quad
    \textbf{(1)} نحصل على أقصر كلمة عندما نعوّض أصغر قيمة لكل بارامتر، أي: $k = 1, n=1$. \\
    لذلك أقصر كلمة هي:
...
\end{boxSolution}
\clearpage
\begin{boxSolution}[سؤال 13 امتحان 899381 سنة 2022 - تكملة]
    \textbf{(2)} \\
        \includegraphics[width=0.7\paperwidth,keepaspectratio]{../../../images/PDAs/c1PlusnPlusk_bk_a2n_nk_ge1.png}%

\begin{enumerate}[label=\alph*., itemsep=2em, start=2]
