...
if (isSorted) Console.WriteLine("Sorted");
...
% \item اكتب عملية تتلقى عددين صحيحين، وتعيد القاسم المشترك الأكبر لهما (أكبر عدد يقسم العددين معًا). \\
% (يمكنك استخدام طريقة التجربة بالتنازل من العدد الأصغر وصولًا للواحد).
% \ifwithsols
% \begin{boxSolution}
% \begin{english}
% \begin{minted}{csharp}
