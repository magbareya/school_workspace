...
public static void InsertAt(int[] arr, int val, int idx)
{
    ...
    \item
    نفس السؤال السابق، لكن العملية لا تتلقى المؤشر \textenglish{idx}، بل تتلقى مصفوفةً مرتبة تصاعديًّا وعدداً صحيحاً \textenglish{val} فقط \\
    على العملية أن تجد المكان الصحيح لإدراج هذا العدد في المصفوفة بحيث تبقى المصفوفة مرتبة تصاعديًّا. \\
