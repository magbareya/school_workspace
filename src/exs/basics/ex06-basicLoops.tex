...
\clearpage
\section{أسئلة حلقات عن تحليل العدد لخاناته}
...
%------------------------------------------------
\clearpage
\section{أسئلة حلقات عن تحليل العدد لعوامله}
...
%------------------------------------------------
\clearpage
\section{أسئلة جدول متابعة للحلقات}
\begin{enumerate}[itemsep=1.5em]
    \item
\end{enumerate}
...
%------------------------------------------------
\clearpage
\section{أسئلة حلقات عن متواليات}
\begin{enumerate}[itemsep=1.5em]
...
%------------------------------------------------
\clearpage
\section{أسئلة حلقات عن النص \textenglish{string}}
