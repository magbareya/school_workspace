...
(أي: في اللحظة i، نحسب متوسط أوّل i أعداد، ونفحص العدد i).
\ifwithsols
\begin{boxSolution}
\begin{english}
\begin{minted}{csharp}
...
\item اكتب برنامجًا يستقبل 20 عددًا صحيحًا من المستخدم. على البرنامج أن يعد ويطبع عدد المرات التي أدخل فيها المستخدم رقمين متتاليين متساويين. \\
