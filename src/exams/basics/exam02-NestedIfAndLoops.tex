...
\begin{boxCode}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \textbf{الفصل الثاني:} الأسئلة 2-4، أجب عن \underline{سؤالين} فقط.
            \item \textbf{الفصل الثالث:} الأسئلة 5-6، أجب عن \underline{سؤال واحد} فقط.
        \end{itemize}
...
\textbf{أجب عن \underline{سؤالين} من الأسئلة 2 - 4}.
...
\textbf{أجب عن \underline{أحد السؤالين} 5 - 6}.

\begin{enumerate}[itemsep=3em, start=5]
...
\item \textbf{السؤال السادس} (30 علامة) \\
