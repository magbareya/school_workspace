...
\begin{enumerate}[label=(\arabic*)]
    \item $\overline{L_1} \cap L_2 = \overline{L_1 \cap \overline{L_2}} $
...
\begin{enumerate}[label=\alph*.]
    \item
\begin{enumerate}[label=(\arabic*)]
    \item غير صحيح. مثال: $L_1=\{a\}$، و$L_2=\{b\}$. عندها: \\
    $\overline{L_1} \cap L_2 = \{b\}$، بينما $\overline{L_1 \cap \overline{L_2}} = \overline{\{a\}}$. \\
    وهاتان لغتان غير متساويتين. مثلًا: $ab \in \overline{\{a\}}$، بينما $ab \notin \{b\}$.
