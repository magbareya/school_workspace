...
\item \textbf{السؤال الأوّل} (20 علامة) \\
...
\hline
\textbf{i} & \textbf{x} & \textbf{count} & \textbf{x < 50} & \textbf{x \% 2 == 0} & \textbf{الطباعة} \\
\hline
 & & 0 & & &  \\
\hline
1 & 30 & & true & true & \textenglish{hello} \\
\hline
2 & 45 & 1 & true & false &  \\
\hline
3 & 60 &  & false & — &  \\
...
4 & 15 & 2 & true & false &  \\
\hline
5 & 22 &  & true & true & \textenglish{hello} \\
\hline
6 & 50 &  & false & — &  \\
\hline
 &  &  &  & & \textenglish{2} \\
...
\textbf{ب.} هناك الكثير من الأمثلة، مثلًا:
$20, 30, 31, 60$

كل رقم زوجي أصغر من 50 يؤدي لطباعة \textenglish{hello}. \\
كل رقم فردي أصغر من 50 يؤدي لزيادة \textenglish{count} \\
كل رقم أكبر أو يساوي 50 لا يؤثّر على شيء.
...
\item \textbf{السؤال الثاني}  (25 علامة) \\
...
\item \textbf{السؤال الثالث} (25 علامة)  \\
...
\begin{enumerate}
    ...
    \textbf{(بونوس +5 علامات)} بعد نهاية الاستقبال، على البرنامج أن يطبع عدد الوجبات الكلي التي تلقاها المطعم في ذلك اليوم.
\end{enumerate}
