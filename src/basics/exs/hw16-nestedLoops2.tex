...
public static void PrintPairsWithSum(int[] arr, int target)
{
    ...
    \begin{itemize}[itemsep=1pt]
        \item العنصر 5: بعده يوجد عددان أكبر منه (7 و8) $\leftarrow$ 2
        \item العنصر 3: بعده يوجد عددان أكبر منه (7 و8) $\leftarrow$ 2
        \item العنصر 7: بعده يوجد عدد واحد أكبر منه (8) $\leftarrow$ 1
        \item العنصر 2: بعده يوجد عدد واحد أكبر منه (8) $\leftarrow$ 1
        \item العنصر 8: لا يوجد شيء بعده $\leftarrow$ 0
    \end{itemize}
